...
public class DictionaryRU extends BaseDictionary {
    private final String addUserIncorrectChatDataException = "Пользователя нельзя добавить в приватный чат";
    ...
    private final String getSecretKeySpecIllegalArgumentException = "Неверный ключ. Должен быть 32 символа";
    private final String saveMessageIncorrectChatDataException = "Этот чат не существует";
